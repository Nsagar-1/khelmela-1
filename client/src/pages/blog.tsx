...
export default function BlogPage() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        setLoading(true);
        const response = await fetch(`/api/blogs?page=${currentPage}&limit=7`);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-lg text-gray-600">Discover insights, tutorials, and the latest gaming trends.</p>
            </div>
            {isLoggedIn && (
              <a href="/blog-creator">
